...
1. ![神贾诩](../assets/images/ext-main/ext4/E4-神贾诩.png) LE004 贾诩 男 神 3体力 称号：倒悬云衢
    ...
    2. 【毒策】：游戏开始时，你随机抽取等同于角色数量的“策”。一名其他角色的出牌阶段限一次，其可付出相应的代价换取一个“策”并执行其效果。回合开始时，你回收所有“策”。
    ...
    - 所有“策”列表（游戏开始时洗混并随机抽取）：
        ...
        - (1个) 代价：减2点体力上限。效果：视为使用一张【盗贼蜂起】或【文和乱武】。

    > 说明：第一个“策”的影响很小，主要目的是给敌方角色一个可用的选择，避免游戏体验过差。  
