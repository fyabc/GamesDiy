...
1. 带触发效果的基本牌/普通锦囊牌：类似于官方国战【敕令】的效果。若一张带触发效果的牌未因使用而从一名角色的手牌进入弃牌堆，则于此回合结束时视为该角色使用了此牌，*且此牌不可被响应*（若此牌需指定目标，则由该角色指定目标；若此牌无合法目标，则取消此牌）。

   > 带触发效果的牌的右上角有闪电形状的触发标记。  
   > 注：带触发效果的牌可通过打出或在弃牌阶段弃置的方式，利用其不可被响应的特点，作为主动输出手段（对于【杀】，还能实现双刀）。
...
|     ♥     |**绝处** |   桃   |   桃   |**析骸**| **顺T**| *巨锤* |   闪   |   闪   |   闪   |**盗贼T**|  血杀T |  血杀  |   桃   |
|     ♣     |**无懈** | *鱼鳞* |**巧取**| **兵** |  血杀  |   杀T  |   杀   |   杀   |   酒   |  血杀   |  血杀  |**绝处**| *弯刀* |
...
6. ![飞熊狼牙棒](../assets/images/ext-main/ext4/E4-XX-飞熊狼牙棒.png) 【飞熊狼牙棒】：装备，武器 攻击范围：3  
    每回合限一次，当你造成伤害时，若此伤害的来源不是实体牌，你可以摸一张牌。
...
2. ![巧取豪夺](../assets/images/ext-main/ext3/E3-S3-巧取豪夺.png)

## 武将

1. ![李傕](../assets/images/heroes/E4-李傕.png) 李傕 男 群 4体力/5上限 QUN023
    1. 【狼袭】：出牌阶段限一次，你可以对攻击范围内的一名其他角色造成1点伤害，然后其可以选择一项：减1点体力上限，废除你的一个装备栏；或废除一个装备栏，令你减1点体力上限。

    > 【狼袭】是否过强？如何改得更有博弈性？设计武器与其配合？
...
1. ![SP刘协](../assets/images/heroes/E4-SP刘协.png) 刘协 男 汉 2体力/3上限 SP-HAN001 称号：危机四伏
    1. 【危境】：每回合限一次，你可以将X张手牌当【绝处逢生】使用（X为你的体力值），然后若你的手牌为唯一最少，你摸一张牌。
    2. 【劝和】：TODO
    3. 【济民】：**主公技**，当一张带触发效果的牌指定目标后，你可令一名汉势力角色回复1点体力。

    > 【济民】取献帝在关中饥荒期间赈济灾民的典故。
