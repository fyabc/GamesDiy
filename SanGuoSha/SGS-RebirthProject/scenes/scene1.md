...
3. 游戏流程
    ...
    5. 进行游戏
        ...
        1. 每轮开始时，*1号位角色*进行**民愤判定**，根据结果增减民愤：♠=+2，♣=+1，♦=0，♥=-1。
    6. 卡牌与技能的特殊规则
    ...
    7. 角色被击退与重整
        ...
        3. 当一名角色被击退时，其进入N回合的重整状态。重整规则具体如下（参考了虎牢关模式的重整规则，并设计了几种变体）：
            ...
            5. 重整规则的设计是为了增加身份等其他模式下先被击退角色的游戏参与度。
        4. 说明
...
9. ![鸣金收兵](../assets/images/scene1/S1.3-HQ-鸣金收兵.png) 【鸣金收兵】：锦囊，延时  
    出牌阶段，对你使用。将【鸣金收兵】置于你的判定区，若判定结果为♥2~9，则保留此牌；若你的判定区内有【鸣金收兵】，一名友方角色成为有花色【杀】的目标时，可将与此【杀】花色相同的牌当【闪】使用。
...
2. ![张宝](./assets/images/scene1/S1.HJ002-张宝.jpg) S1.HJ002 张宝 男 群 3体力 称号：地公将军
    ...
    3. 【某某】：**主帅技**，其他友方角色的出牌阶段限一次，该角色可以用一张黑色手牌替换一张“咒”。
...
1. ![廖化](./assets/images/scene1/S1.QUN001-廖化.jpg) S1.QUN001 廖化 男 群 4体力 称号：啸聚山林
    ...
    > 该技能组是对本模式特有的重整机制的一个设计尝试。
2. ![公孙瓒](./assets/images/scene1/S1.QUN002-公孙瓒.jpg) S1.QUN002 公孙瓒 男 群 4体力 称号：白马将军
...
3. ![马腾](./assets/images/scene1/S1.QUN003-马腾.jpg) S1.QUN003 马腾 男 群 4体力 称号：驰骋西陲
    ...
    2. 【雄异】：**限定技**，出牌阶段，你可以令所有友方角色各摸两张牌，所有处于重整状态的友方角色获得一个重整标记，然后你可以变更此武将。

    > 该技能组是对变更武将效果的一个设计尝试。
4. ![诸葛瑾](./assets/images/scene1/S1.QUN020-诸葛瑾.jpg) S1.QUN020 诸葛瑾 男 群 3体力 称号：联盟的维系者
    1. 【缓释】：己方角色的判定牌生效前，你可以观看牌堆顶的三张牌，然后以任意顺序置于牌堆顶。
    2. 【弘援】：摸牌阶段，你可以少摸一张牌，然后令其他己方角色各摸一张牌。
