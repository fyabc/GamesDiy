...
4. 文和乱武（192 - 195）
    ...
    4. 神武将：贾诩
    5. 概念与机制：带触发效果的基本牌/普通锦囊牌
5. 江东定基（194 - 200）
    1. 武将：太史慈、张纮、程普、朱治、大乔、小乔、刘繇、陆康、严白虎、许贡
    2. SP武将：周瑜2、王朗2、华歆2
...
26. 六出祁山（228 - 234）
    ...
    4. 神武将：暂无
27. 石亭之战（228）
    1. 武将：周鲂、朱桓、全琮、张昭、曹休、贾逵、满宠、TODO
    2. SP武将：陆逊2
    3. 已在标准版或其他扩展中出现的武将：TODO
    4. 神武将：暂无
28. 南鲁党争（242 - 250）
